...
- `QR-011` Public menu presentation includes all published, enabled, currently sellable items and bundles. It has a shareable link suitable for LINE and other platforms and a stable menu-image/export presentation where supported.
