...
export const resilienceFeatureFlagDefaults: Record<ResilienceFeatureFlagCode, boolean> = {
  ...
  FOODPANDA_ORDERS_ENABLED: false,
  FOODPANDA_CATALOG_READ_ENABLED: false,
  FOODPANDA_CATALOG_WRITE_ENABLED: false,
  FOODPANDA_OUTLET_ENABLED: false,
  FOODPANDA_PRODUCT_CREATE_BETA_ENABLED: false,
  UBER_EATS_ORDERS_ENABLED: false,
  UBER_EATS_MENU_READ_ENABLED: false,
  UBER_EATS_MENU_FULL_WRITE_ENABLED: false,
  UBER_EATS_MENU_ITEM_WRITE_ENABLED: false,
  UBER_EATS_STORE_READ_ENABLED: false,
  UBER_EATS_STORE_STATUS_WRITE_ENABLED: false,
  UBER_EATS_HOLIDAY_HOURS_WRITE_ENABLED: false,
  UBER_EATS_STORE_ACTIVATION_ENABLED: false,
  UBER_EATS_REPORTS_READ_ENABLED: false,
  UBER_EATS_ORDER_READY_ENABLED: false,
  UBER_EATS_ORDER_READY_TIME_ENABLED: false,
  UBER_EATS_FULFILLMENT_ISSUES_ENABLED: false,
  DIGITAL_WAITLIST_FOUNDATION_ENABLED: false,
  ONLINE_ORDER_PAYMENT_ENABLED: false,
  PAYMENTS_FOUNDATION_ENABLED: false,
  PAYMENTS_ADMIN_UI_ENABLED: false,
  PAYMENTS_MOCK_PROVIDER_ENABLED: false,
  PAYMENTS_LINE_PAY_ENABLED: false,
  PAYMENTS_JKO_PAY_ENABLED: false,
  PAYMENTS_TWQR_ENABLED: false,
  PAYMENTS_TAIWAN_PAY_ENABLED: false,
  PAYMENTS_PX_PAY_PLUS_ENABLED: false,
  PAYMENTS_IPASS_MONEY_ENABLED: false,
  PAYMENTS_ICASH_PAY_ENABLED: false,
  PAYMENTS_PLUS_PAY_ENABLED: false,
  PAYMENTS_EASY_WALLET_ENABLED: false,
  PAYMENTS_GAMA_PAY_ENABLED: false,
  PAYMENTS_OPAY_ENABLED: false,
  PAYMENTS_GATEWAY_ENABLED: false,
  ...
  MODULE_CORE_OPS_ENABLED: true,
  MODULE_GROWTH_ENABLED: false,
  MODULE_OMNI_ENABLED: false,
  MODULE_HQ_ENABLED: false,
  MODULE_SUPPLY_LITE_ENABLED: false,
  MODULE_EVENT_GROWTH_ENABLED: false,
  MODULE_PUBLIC_API_ENABLED: false,
