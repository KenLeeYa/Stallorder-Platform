...
const definitions = {
  ...
  "reports.filter.day": ["今天", "Today", "今日", "오늘", "Hôm nay", "วันนี้"],
  "reports.filter.yesterday": ["昨天", "Yesterday", "昨日", "어제", "Hôm qua", "เมื่อวาน"],
  "reports.filter.week": ["本週", "This week", "今週", "이번 주", "Tuần này", "สัปดาห์นี้"],
  "reports.filter.month": ["本月", "This month", "今月", "이번 달", "Tháng này", "เดือนนี้"],
  "reports.filter.custom": ["自訂", "Custom", "カスタム", "사용자 지정", "Tùy chỉnh", "กำหนดเอง"],
