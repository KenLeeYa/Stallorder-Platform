        ...
        <div className="fixed inset-0 z-50 grid place-items-center overflow-y-auto bg-black/45 p-4">
          <form onSubmit={saveProduct} role="dialog" aria-modal="true" aria-labelledby="product-editor-title" className="my-auto w-full max-w-lg rounded-lg bg-white p-5 shadow-xl">
            ...
            <div className="mt-4 grid gap-4 sm:grid-cols-2">
              <label className="text-sm font-medium text-stone-700 sm:col-span-2">商品名稱<input type="text" required maxLength={80} value={productDraft.name} onChange={(event) => setProductDraft({ ...productDraft, name: event.target.value })} className="mt-1 w-full rounded-md border border-stone-300 px-3 py-2" /></label>
        ...
        <div className="fixed inset-0 z-50 grid place-items-center bg-black/45 p-4">
          <form onSubmit={saveCategory} role="dialog" aria-modal="true" aria-labelledby="category-editor-title" className="w-full max-w-md rounded-lg bg-white p-5 shadow-xl">
            ...
            <div className="mt-4 grid gap-4">
              <label className="text-sm font-medium text-stone-700">分類名稱<input type="text" required maxLength={50} value={categoryDraft.name} onChange={(event) => setCategoryDraft({ ...categoryDraft, name: event.target.value })} className="mt-1 w-full rounded-md border border-stone-300 px-3 py-2" /></label>
