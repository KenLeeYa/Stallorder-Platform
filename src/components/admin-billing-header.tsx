  ...
  return (
    <header className="sticky top-0 z-30 border-b border-stone-200 bg-white/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-3 px-4 py-3 md:px-8">
        <Link href="/admin/billing" className="mr-auto font-semibold text-stone-950">平台管理後台</Link>
        <nav aria-label="平台管理導覽" className="order-3 flex w-full gap-1 overflow-x-auto lg:order-none lg:w-auto">
          {items.map((item) => {
