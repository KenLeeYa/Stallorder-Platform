...
export default async function AdminSubscriptionDetailPage({ params }: PageProps) {
  ...
  return (
    <main className="mx-auto min-h-[calc(100vh-76px)] max-w-5xl px-4 py-7 md:px-8">
      <ContextualBackButton fallbackHref="/admin/subscriptions" className="inline-flex min-h-10 items-center gap-2 text-sm font-semibold text-teal-800">{m("Back to subscriptions")}</ContextualBackButton>
