...
export default async function AdminBillingPage() {
  ...
  return (
    <main className="mx-auto min-h-[calc(100vh-76px)] max-w-7xl px-4 py-7 md:px-8">
      ...
      <section className="border-y border-stone-200 bg-stone-50 py-4 text-sm"><strong>{m("E-invoice integration is not enabled")}</strong><p className="mt-1 text-stone-600">{m("This page manages only StallOrder invoices and never calls external payment or e-invoice services.")}</p></section>
    </main>
  );
}
