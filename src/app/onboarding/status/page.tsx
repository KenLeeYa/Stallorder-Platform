...
function statusNextStep(status: string) {
  ...
  if (status === "WITHDRAWN") return "本次申請已結束；你可以沿用原資料重新提出新申請，舊案仍會保留供日後查閱。";
