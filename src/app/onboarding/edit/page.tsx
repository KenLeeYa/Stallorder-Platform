...
export default async function EditMerchantApplicationPage() {
  ...
  return <OnboardingShell><OnboardingForm authenticatedProfile={data.profile} initialValues={serializeApplicationInitialValues(data.application)} trial={data.trial} needsInfoNote={data.application.publicReviewNote} /></OnboardingShell>;
}
