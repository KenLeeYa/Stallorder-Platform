...
export default async function StallProductsRoute({ params }: PageProps) {
  ...
  if (![...workspace.roles, ...stall.roles].some((role) => hasPermission(role, "MANAGE_PRODUCTS"))) notFound();
  redirect(`/merchant/${stall.slug}`);
}
