...
const copies = {
  "zh-TW": { title: "帳號與安全性", description: "管理登入方式與已登入裝置。供應商識別碼、權杖與完整瀏覽器指紋不會顯示於此頁。", loginMethods: "登入方式", loginDescription: "不同供應商只會在明確綁定後連到同一個 StallOrder 帳號，不會只憑 Email 自動合併。", linked: "已綁定", notLinked: "尚未綁定", link: "綁定", unlink: "解除綁定", lastLinked: "最近使用", unavailable: "未設定或功能旗標未開啟", lastIdentityWarning: "至少需保留一個可用登入方式。", sessions: "登入裝置", sessionsDescription: "顯示瀏覽器可辨識的裝置類型，不顯示 IP、Cookie 或完整瀏覽器指紋；Safari 通常不提供精確硬體型號。", currentDevice: "目前裝置", otherDevice: "其他裝置", lastActive: "最近活動", expires: "到期", logoutDevice: "登出此裝置", logoutAll: "登出所有裝置", passkeys: "Passkeys / WebAuthn", passkeyReady: "Passkey challenge 與資料模型已就緒；正式註冊仍需完成 WebAuthn attestation verifier 驗證。", passkeyBlocked: "Passkey 預設關閉，完成 RP ID、Origin 與 WebAuthn verifier 驗證後才能啟用。", actionFailed: "操作失敗，請稍後再試。", confirmUnlink: "解除綁定會登出所有裝置，確定繼續？", confirmLogoutAll: "確定登出所有裝置？" },
  en: { title: "Account and security", description: "Manage login methods and signed-in devices. Provider subjects, tokens, and full browser fingerprints are never shown here.", loginMethods: "Login methods", loginDescription: "Providers connect to the same StallOrder account only through explicit linking; Email alone never merges accounts.", linked: "Linked", notLinked: "Not linked", link: "Link", unlink: "Unlink", lastLinked: "Last used", unavailable: "Not configured or disabled", lastIdentityWarning: "Keep at least one usable login method.", sessions: "Signed-in devices", sessionsDescription: "Shows the device family the browser exposes, without IP, cookies, or full browser fingerprints. Safari usually does not expose the exact hardware model.", currentDevice: "Current device", otherDevice: "Other device", lastActive: "Last active", expires: "Expires", logoutDevice: "Log out device", logoutAll: "Log out all devices", passkeys: "Passkeys / WebAuthn", passkeyReady: "The Passkey challenge and data model are ready; registration still requires a verified WebAuthn attestation verifier.", passkeyBlocked: "Passkeys default OFF until RP ID, Origin, and the WebAuthn verifier are verified.", actionFailed: "The action failed. Try again.", confirmUnlink: "Unlinking signs out every device. Continue?", confirmLogoutAll: "Log out every device?" },
  vi: { title: "Tài khoản và bảo mật", description: "Quản lý phương thức đăng nhập và thiết bị đã đăng nhập. Không hiển thị mã định danh, token hay dấu vân tay trình duyệt đầy đủ.", loginMethods: "Phương thức đăng nhập", loginDescription: "Chỉ liên kết rõ ràng mới nối nhà cung cấp vào cùng tài khoản; không tự gộp chỉ theo Email.", linked: "Đã liên kết", notLinked: "Chưa liên kết", link: "Liên kết", unlink: "Hủy liên kết", lastLinked: "Dùng gần nhất", unavailable: "Chưa cấu hình hoặc đang tắt", lastIdentityWarning: "Phải giữ ít nhất một phương thức đăng nhập khả dụng.", sessions: "Thiết bị đăng nhập", sessionsDescription: "Hiển thị loại thiết bị mà trình duyệt cung cấp, không hiển thị IP, Cookie hay dấu vân tay đầy đủ. Safari thường không cung cấp chính xác mẫu phần cứng.", currentDevice: "Thiết bị hiện tại", otherDevice: "Thiết bị khác", lastActive: "Hoạt động gần nhất", expires: "Hết hạn", logoutDevice: "Đăng xuất thiết bị", logoutAll: "Đăng xuất mọi thiết bị", passkeys: "Passkeys / WebAuthn", passkeyReady: "Challenge và mô hình dữ liệu Passkey đã sẵn sàng; đăng ký thật vẫn cần verifier WebAuthn đã xác minh.", passkeyBlocked: "Passkey mặc định tắt đến khi xác minh RP ID, Origin và verifier WebAuthn.", actionFailed: "Thao tác thất bại. Vui lòng thử lại.", confirmUnlink: "Hủy liên kết sẽ đăng xuất mọi thiết bị. Tiếp tục?", confirmLogoutAll: "Đăng xuất mọi thiết bị?" },
} as const;
