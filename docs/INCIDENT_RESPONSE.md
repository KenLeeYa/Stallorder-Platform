...
2026-09-12 補充：[DR 誤部署至正式專案事故](incidents/2026-09-12-dr-production-outage.md) 記錄根因、10:02 恢復證據與後續變更檢查要求。當時尚未公開推廣，三間商家協助測試，事故發生於非使用時段；此背景不降低正式站可用性要求。DR 資源清理成功不等於正式站恢復，必須讀回正式部署與網址並驗證登入及相關流程。
