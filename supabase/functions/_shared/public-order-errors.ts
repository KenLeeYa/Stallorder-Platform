export function errorMessage(code: string) {
  ...
  const messages: Record<string, string> = {
    ...
    QR_LAST_ORDER_PASSED: "超過最後點餐時間，請至櫃檯詢問。",
    PRODUCT_STOCK_INSUFFICIENT: "部分商品庫存不足，請調整數量後再試。",
