...
alter table public.external_orders
  ...
  add constraint external_orders_connection_provider_order_key
...
alter table public.delivery_webhook_events
  ...
  add constraint delivery_webhook_events_connection_provider_replay_key
...
alter table public.delivery_sync_jobs
  ...
  add constraint delivery_sync_jobs_connection_provider_deduplication_key
